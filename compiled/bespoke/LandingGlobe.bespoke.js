...
`)+`
`+h);let M=x+f+o,y=x+h+a,R=Su(s,s.VERTEX_SHADER,M),C=Su(s,s.FRAGMENT_SHADER,y);s.attachShader(_,R),s.attachShader(_,C),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function I(P){if(i.debug.checkShaderErrors){let O=s.getProgramInfoLog(_)||"",z=s.getShaderInfoLog(R)||"",b=s.getShaderInfoLog(C)||"",A=O.trim(),w=z.trim(),B=b.trim(),F=!0,V=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(F=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,R,C);else{let N=Eu(s,R,"vertex"),Z=Eu(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
