<?php
    ...
    try{
        ...
        $results = fetch(
            "SELECT res.region_id, reg.title as region_title, res.election_id as election, res.election_subid as election_subid, e.date as election_date, e.title as election_title, res.party, res.candidate, res.votes, res.elected 
        ...
        */
        ...
        foreach($results as $result){
            ...
            if(!$matching_event){
                ...
                if(!is_null($result['election_subid'])) $new_event['data']['subid'] = $result['election_subid'];
