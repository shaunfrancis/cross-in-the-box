...
<?= RegionLayout::openSidebar(); ?>
    ...
    <?php if(empty($_error)) : ?>
        <section>
            ...
            <p>Candidate names for the 2026 and 2016 elections are sourced from <a href="https://democracyclub.org.uk" target="_blank">Democracy Club</a>, which is licensed under the <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank">Creative Commons Attribution 4.0 (CC BY 4.0) license</a>. Candidate names for the 2021 and 2011 elections are sourced from <a href="https://www.bbc.co.uk/news/election/2021/scotland/results" target="_blank">BBC News</a>.</p>
