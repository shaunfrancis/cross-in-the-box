<?php 
    namespace Shared;
    $_headInjections[] = '<script src="/compiled/bespoke/UKConstituencyMap.bespoke.js" defer></script>';
    $_headInjections[] = '<link rel="stylesheet" type="text/css" href="/compiled/bespoke/UKConstituencyMap.bespoke.css" />';
    $heroNavItems = [
