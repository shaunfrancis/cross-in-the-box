...
$_title[] = $region['title'];
$_description[] = "Browse election results and data for the {$region['title']} constituency.";
$_breadcrumb = ['title' => $region['title'], 'path' => 'uk/general-elections/constituency/' . UK\regionToSlug($region['title'])];