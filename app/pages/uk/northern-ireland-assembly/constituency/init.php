...
$region = API\SlugLookupService::call(["uk", $slug, "ni"]);
...
if(!empty($data['events'][0]['region']['title']) && $data['events'][0]['region']['title'] != $region['title']){
    ...
    $_headInjections[] = sprintf('<link rel="canonical" href="https://crossinthebox.com/uk/northern-ireland-assembly/constituency/%s" />', $newSlug);
