...
<section id="hero">
    <a href="/new-zealand/general-elections/" class="breadcrumb">
...
<?= RegionLayout::openSidebar(); ?>
    ...
    <?php if(empty($_error)) : ?>
        <section>
            <p>Election results are sourced from New Zealand's <a href="https://www.electionresults.govt.nz" target="_blank">Electoral Commission</a>.</p>
